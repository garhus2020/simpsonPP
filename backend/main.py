...
import requests
import base64
# DZjFY1w9_TJoVDsqKAtrQ29eVSgaUDRd57D86t5qC
...
async def find_confounder(
    ...
    if (flag ==0):
        ...
        return  {
                'response': 'https://simpsonpp.s3.eu-north-1.amazonaws.com/'+namef,
    ...
    sendS3(fig, namef) # Sending photo to AWS S3 to save and later use in source component
    return {
            'dist': 'https://simpsonpp.s3.eu-north-1.amazonaws.com/'+namef,
            'confounding_variable': conf,
            'reversed_params' : prop,
            'agg_data': agg_data,
...
def sendS3(fig, namef):
        ...
        buf.seek(0)
        url = 'https://as2qk33pq2.execute-api.eu-north-1.amazonaws.com/default/upload-simpson-photo'
        data = buf.getvalue()
